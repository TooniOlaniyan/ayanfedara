...
export const NavLinks = [
  { href: "/", key: "biography", text: "biography" },
  { href: "/", key: "works", text: "works" },
  { href: "/", key: "contact", text: "contact" },
];

export const biographyContent = [
  "With a keen eye on blockchain technology, I navigate the Web3 landscape, exploring decentralized finance (DeFi), non-fungible tokens (NFTs), and the disruptive potential of blockchain.",
